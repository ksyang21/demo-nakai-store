        ...
        <div class="">
          <div class="py-1 flex relative max-w-xl mx-auto">
            <input
              ...
              class="text-sm border w-full pr-52 focus:ring-red-400 focus:border-red-400 relative px-5 placeholder-gray-400 py-6 -right-1 border-red-400 rounded-lg flex-grow"
            />
            <span
      ...
      <div class="max-w-6xl gap-6 mx-auto grid grid-cols-1 md:grid-cols-9">
        <div class="md:col-span-3 py-3 space-y-4">
          ...
          <div class="text-gray-300 w-60 pr-0">
            We sell only but quality and first grade Hoddies, Joggers, Shorts
            and lot more.
          </div>
        </div>
