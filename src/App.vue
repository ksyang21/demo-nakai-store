...
<template>
  ...
  <div
    class="fixed top-12 bg-green-600 text-white z-50 border text-md uppercase shadow-lg py-1 px-4 rounded-lg transistion-all duration-700"
    :class="notify"
  >
...
export default {
  ...
  methods: {
    ...
    addP(data) {
      ...
      axios
        .post(
          `${import.meta.env.VITE_baseUrl}/store/carts/${
            this.cartId
          }/line-items`,
          {
            variant_id: data,
